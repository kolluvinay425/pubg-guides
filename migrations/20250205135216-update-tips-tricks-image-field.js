...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.addColumn("TipsTricks", "image_temp", {
    ...
    await queryInterface.removeColumn("TipsTricks", "image");

    // Rename the temporary column to image
    await queryInterface.renameColumn("TipsTricks", "image_temp", "image");
  },
